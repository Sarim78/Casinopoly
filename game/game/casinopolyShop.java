    ...
    public void giveStuff() {
        if (buyingOption.equals("1")) {
            ...
            if (confirmChoice.equals("n") || confirmChoice.equals("N")) {
                ...
                player.playersMoney = player.playersMoney - 1000;
            ...
            if (confirmChoice.equals("n") || confirmChoice.equals("N")) {
                ...
                sleep300();
                shopCounter = shopCounter + 1;
                player.playersMoney = player.playersMoney - 2500;
                System.out.println(player.showMoney);
            ...
            if (confirmChoice.equals("n") || confirmChoice.equals("N")) {
                ...
                shopCounter = shopCounter + 1;
                player.playersMoney = player.playersMoney - 5000;
                System.out.println(player.showMoney);
                sleep1500();
                displayBuyingOptions();
                //in.close();
            ...
            if (confirmChoice.equals("n") || confirmChoice.equals("N")) {
                ...
                shopCounter = shopCounter + 1;
                player.playersMoney = player.playersMoney - 3500;
                System.out.println(player.showMoney);
                sleep1500();
                displayBuyingOptions();
                //in.close();
            ...
            if (confirmChoice.equals("n") || confirmChoice.equals("N")) {
                ...
                shopCounter = shopCounter + 1;
                player.playersMoney = player.playersMoney - 10000;
                System.out.println(player.showMoney);
                sleep1500();
                displayBuyingOptions();
                //in.close();
            ...
            if (confirmChoice.equals("n") || confirmChoice.equals("N")) {
                ...
                shopCounter = shopCounter + 1;
                player.playersMoney = player.playersMoney - 12500;
                System.out.println(player.showMoney);
                sleep1500();
                displayBuyingOptions();
                //in.close();
            ...
            if (confirmChoice.equals("n") || confirmChoice.equals("N")) {
                ...
                displayBuyingOptions();
                //in.close();
            } else if (player.playersMoney < 30000) {
    ...
    public void lotteryTickets() {
        ...
        if (ticketChoice.equals("1")) {
            ...
            if (lotteryTicket1 <= 15) {
                ...
                player.playersMoney = player.playersMoney + 15000;
                System.out.println(player.showMoney);
            ...
            if (lotteryTicket2 <= 15) {
                ...
                player.playersMoney = player.playersMoney + 30000;
                System.out.println(player.showMoney);
